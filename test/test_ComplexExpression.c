...
void test_complexExpression_explore_integer(void)
{
	...
	//_complexExpressionInt(&a,&b,&result,addInt,multInt,assignInt);
	_complexExpressionInt(&a,&b,&result); //macro
...
void test_complexExpression_explore_float(void)
{
	...
	//_complexExpressionInt(&a,&b,&result,addFloat,multFloat,assignFloat);
	_complexExpressionFloat(&a,&b,&result); //macro
